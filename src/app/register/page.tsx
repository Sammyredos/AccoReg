      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-sm sm:text-base text-gray-600 font-apercu-regular px-2 leading-relaxed">
              Register for Our Upcoming Youth Revival - Linger no Longer 7.0
            </p>
          </div>
        </div>
        ...
        <div className="mb-8 sm:mb-10">
          <div className="relative">
            ...
            {/* Active Progress Bar */}
            <div className={`absolute top-4 left-0 h-0.5 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full transition-all duration-500 ease-in-out ${currentStep >= 2 ? 'w-1/2' : 'w-0'
            ...
            <div className="relative flex justify-between">
              ...
              <div className="flex flex-col items-center">
                <div className={`relative flex items-center justify-center w-8 h-8 rounded-full text-sm font-apercu-bold transition-all duration-300 ${currentStep >= 1
                ...
                <div className="mt-3 text-center">
                  <div className={`text-sm font-apercu-bold transition-colors duration-300 ${currentStep >= 1 ? 'text-indigo-600' : 'text-gray-500'
                    }`}>
                    Personal Info
                  </div>
              ...
              {/* Step 2 */}
              <div className="flex flex-col items-center">
                <div className={`relative flex items-center justify-center w-8 h-8 rounded-full text-sm font-apercu-bold transition-all duration-300 ${currentStep >= 2
                    ? 'bg-gradient-to-r from-indigo-500 to-purple-600 text-white shadow-lg shadow-indigo-200'
                    : 'bg-white border-2 border-gray-300 text-gray-500'
                  }`}>
                  {currentStep > 2 ? (
                ...
                <div className="mt-3 text-center">
                  <div className={`text-sm font-apercu-bold transition-colors duration-300 ${currentStep >= 2 ? 'text-indigo-600' : 'text-gray-500'
                    }`}>
                    Parent Info
                  </div>
                  <div className="text-xs text-gray-500 font-apercu-regular mt-1">
              ...
              {/* Step 3 */}
              <div className="flex flex-col items-center">
                <div className={`relative flex items-center justify-center w-8 h-8 rounded-full text-sm font-apercu-bold transition-all duration-300 ${currentStep >= 3
                    ? 'bg-gradient-to-r from-indigo-500 to-purple-600 text-white shadow-lg shadow-indigo-200'
                    : 'bg-white border-2 border-gray-300 text-gray-500'
                  }`}>
                  3
                ...
                <div className="mt-3 text-center">
                  <div className={`text-sm font-apercu-bold transition-colors duration-300 ${currentStep >= 3 ? 'text-indigo-600' : 'text-gray-500'
                    }`}>
                    Emergency
                  </div>
                  <div className="text-xs text-gray-500 font-apercu-regular mt-1">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative">
                            <input
                              ...
                              className={`block w-full px-3 sm:px-4 py-2.5 sm:py-3 border rounded-lg shadow-sm font-apercu-regular focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 ${getFieldError('fullName')
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative">
                            <select
                              ...
                              onChange={handleChange}
                              className={`block w-full px-3 sm:px-4 py-2.5 sm:py-3 border rounded-lg shadow-sm font-apercu-regular focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 ${getFieldError('gender')
                                  ? 'border-red-300 focus:border-red-500 focus:ring-red-500 bg-red-50'
                                  : 'border-gray-300 hover:border-indigo-300 bg-white hover:shadow-md'
                                }`}
                            >
                          ...
                          <div className="grid grid-cols-3 gap-3">
                            ...
                            <div className="relative">
                              ...
                              <select
                                ...
                                className={`block w-full px-3 py-1 border-2 rounded-md shadow-sm font-apercu-regular focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 h-9 ${getFieldError('dateOfBirth')
                        ...
                        <div className="space-y-2 lg:col-span-2">
                          ...
                          <div className="relative">
                            <textarea
                              ...
                              onChange={handleChange}
                              rows={3}
                              className={`block w-full px-3 sm:px-4 py-2.5 sm:py-3 border rounded-lg shadow-sm font-apercu-regular focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 resize-none ${getFieldError('address')
                                  ? 'border-red-300 focus:border-red-500 focus:ring-red-500 bg-red-50'
                                  : 'border-gray-300 hover:border-indigo-300 bg-white hover:shadow-md'
                                }`}
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative">
                            <select
                              ...
                              onChange={handleChange}
                              className={`block w-full px-3 sm:px-4 py-2.5 sm:py-3 border rounded-lg shadow-sm font-apercu-regular focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 ${getFieldError('branch')
                                  ? 'border-red-300 focus:border-red-500 focus:ring-red-500 bg-red-50'
                                  : 'border-gray-300 hover:border-indigo-300 bg-white hover:shadow-md'
                                }`}
                            >
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative">
                            <input
                              ...
                              onChange={handleChange}
                              className={`block w-full px-3 sm:px-4 py-2.5 sm:py-3 border rounded-lg shadow-sm font-apercu-regular focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 ${getFieldError('phoneNumber')
                                  ? 'border-red-300 focus:border-red-500 focus:ring-red-500 bg-red-50'
                                  : 'border-gray-300 hover:border-indigo-300 bg-white hover:shadow-md'
                                }`}
                        ...
                        <div className="space-y-2 lg:col-span-2">
                          ...
                          <div className="relative">
                            <input
                              ...
                              onChange={handleChange}
                              className={`block w-full px-3 sm:px-4 py-2.5 sm:py-3 border rounded-lg shadow-sm font-apercu-regular focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 ${getFieldError('emailAddress')
                                  ? 'border-red-300 focus:border-red-500 focus:ring-red-500 bg-red-50'
                                  : 'border-gray-300 hover:border-indigo-300 bg-white hover:shadow-md'
                                }`}
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative">
                            <input
                              ...
                              onChange={handleChange}
                              className={`block w-full px-3 sm:px-4 py-2.5 sm:py-3 border rounded-lg shadow-sm font-apercu-regular focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 ${getFieldError('parentGuardianName')
                                  ? 'border-red-300 focus:border-red-500 focus:ring-red-500 bg-red-50'
                                  : 'border-gray-300 hover:border-indigo-300 bg-white hover:shadow-md'
                                }`}
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative">
                            <input
                              ...
                              onChange={handleChange}
                              className={`block w-full px-3 sm:px-4 py-2.5 sm:py-3 border rounded-lg shadow-sm font-apercu-regular focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 ${getFieldError('parentGuardianPhone')
                                  ? 'border-red-300 focus:border-red-500 focus:ring-red-500 bg-red-50'
                                  : 'border-gray-300 hover:border-indigo-300 bg-white hover:shadow-md'
                                }`}
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative">
                            <input
                              ...
                              onChange={handleChange}
                              className={`block w-full px-3 sm:px-4 py-2.5 sm:py-3 border rounded-lg shadow-sm font-apercu-regular focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 ${getFieldError('emergencyContactName')
                                  ? 'border-red-300 focus:border-red-500 focus:ring-red-500 bg-red-50'
                                  : 'border-gray-300 hover:border-indigo-300 bg-white hover:shadow-md'
                                }`}
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative">
                            <input
                              ...
                              onChange={handleChange}
                              className={`block w-full px-3 sm:px-4 py-2.5 sm:py-3 border rounded-lg shadow-sm font-apercu-regular focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 ${getFieldError('emergencyContactPhone')
                                  ? 'border-red-300 focus:border-red-500 focus:ring-red-500 bg-red-50'
                                  : 'border-gray-300 hover:border-indigo-300 bg-white hover:shadow-md'
                                }`}
